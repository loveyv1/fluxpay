#![cfg(test)]
use super::*;
use rex_token::{RexToken, RexTokenClient};
...
fn test_batch_operation() {
    ...
    // Batch operation swaps REX for XLM and takes a 5% fee (10 REX)
