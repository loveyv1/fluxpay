...
const REX_ASSET = new Asset('REX', issuerKeypair.publicKey());
...
async function setupTrustlines() {
  try {
    ...
    console.log("Issued 1,000,000 REX to distributor");
...
module.exports = { setupTrustlines, addTrustline, REX_ASSET };
