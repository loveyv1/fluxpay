...
const REX_ISSUER = process.env.NEXT_PUBLIC_REX_ISSUER || 'GCNDTZPBGK5CBWN4BSCQRVC3UWQ7MXZJRVHFFUV5L65EUZFCW3YOBXG4';
...
export const useTrustline = (publicKey: string) => {
  ...
  const addTrustline = async () => {
    ...
    try {
      ...
      const rexAsset = new Asset('REX', REX_ISSUER);
